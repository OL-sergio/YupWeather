...
public final class Constants {
    ...
    public static final String BASE_URL_DAY = BuildConfig.BASE_URL;
    //https://pro.openweathermap.org/data/2.5/forecast/
    public static final String BASE_URL_FORECAST = "https://pro.openweathermap.org/data/2.5/forecast/";
